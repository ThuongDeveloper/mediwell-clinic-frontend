...
public class CompanyController {
    ...
    public String create(Model model, Company company, RedirectAttributes redirectAttributes) {
        try {
    ...
    public String update(Model model, @PathVariable("id") Integer id, Company updatedCompany, RedirectAttributes redirectAttributes) {
